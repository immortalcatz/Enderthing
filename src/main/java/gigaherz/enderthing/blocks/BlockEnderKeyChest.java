        ...
        extends BlockRegistered
{
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        if(playerIn.isSneaking())
        {
            ...
            {
                Enderthing.logger.warn("Bound to: " + chest.getPlayerBound());
                Enderthing.logger.warn("Activating player is: " + playerIn.getUniqueID());
            }
            else
            {
                Enderthing.logger.warn("Not bound, chest is: " + (state.getValue(PRIVATE) ? "private" : "global"));
            }
        }
